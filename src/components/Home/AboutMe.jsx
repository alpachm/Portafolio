        ...
        <div className='about-me sec' id='aboutMe'>
            <div className="content-aboutMe hiddenLeft">
                ...
                <div className="text-aboutMe grilla">
                    ...
                    <span>Mi objetivo es poder dar vida a cualquier proyecto que tengas en mente en el ámbito digital</span>

                    <p>Soy un desarrollardor web Front-End apasionado con lo que hace día a día. Dedicado, disciplinado y comprometido con todo lo que hago.</p>

                    <p>Me esfuerzo para dar lo mejor de mí en cada proyecto que participo y de esta manera cumplir con todo lo que se exige.</p>
