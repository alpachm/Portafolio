...
const works = [
  {
    ...
    resumen:
      'Página completa desarrollada para cliente y realizada con REACT donde se muestra los servicios que ofrecen.',
    descripcion:
      'Este fue mi primero proyecto real donde tuve la oportunidad de poner en práctica todo lo aprendido hasta ese momento. Fue un completo desafio que asumí con mucha responsabilidad y compromiso. Tuve que leer mucha documentación para poder agregar funcionalidades que faltaban. Prestando mucha atención a todo lo que mi cliente quería para su página web logré desarrollar este proyecto donde quedó completamente satisfecho.',
    url: 'https://www.techosyplacas.com.co/',
  },
  {
    id: 2,
    proyecto: 'Practica',
  ...
  },
  {
    ...
    librerias: ['axios', 'react-router-dom', 'react-hook-form', 'react-redux'],
    resumen:
      'Sitio web que muestra toda la info de los pokemones y los filtra por su tipo. Cuenta con Dark Mode.',
    descripcion:
      'Proyecto realizado para poner en práctica peticiones asincrónicas y estados globales utilizando redux. Añadiendo el dark-mode intenté darle un toque más complejo y completo al proyecto.',
  ...
  },
  {
    ...
    librerias: ['axios'],
    resumen:
      'Sitio web que muestra toda la info de la serie animada Rick&Morty. Cuenta con Dark Mode.',
    descripcion:
      'Proyecto realizado en equipo de 4 personas para afianzar conocimientos en GitHub y trabajo en equipo. Con este proyecto reforzamos conocimiento de peticiones asincrónicas',
  ...
  },
  {
    ...
    librerias: ['axios'],
    resumen:
      'Sitio web que muestra la temperatura y estado de clima dependiendo de la ubicación del usuario.',
    descripcion:
      'Proyecto realizado para reforzar conocimiento en peticiones asincrónicas.',
  ...
  },
  {
    ...
    librerias: ['axios'],
    resumen:
      'Sitio web donde puedes consultar información de cada país a través de un buscador. Cuenta con Dark Mode.',
    descripcion:
      'Proyecto personal realizado para practicar nuevos conceptos. Consumiendo API pública de paises y agregando funcionalidades extras para sacar máximo provecho.',
  ...
  },
  {
    ...
    resumen:
      'Ecommerce con las funcionalidades de agregar al carrito, eliminar o comprar. Cuenta con Dark Mode.',
    descripcion:
      'Proyecto realizado para fortalecer conocimientos en JavasCript y el DOM. Se imprimen los productos de forma dinámica a través del DOM y se utiliza lógica de programación para el carrito de compras.',
  ...
  },
  {
    ...
    descripcion:
      'Maquetado de un ejemplo de portafolio. Este proyecto se realizó con el fin de utilizar las técnologias de HTML y CSS, además de entender muy bien los conceptos de Grid CSS y FlexBox CSS.',
  ...
  },
  {
    ...
    descripcion:
      'Proyecto realizado para fortalecer conocimientos en fundamentos como HTML y CSS. Maquetado 100% responsive. Proyecto importante para comprender conceptos como fleblox css y grid css',
